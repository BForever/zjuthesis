...
\documentclass[
    ...
    % Title
    Title           = 基于视觉SLAM,
    TitleEng        = {Research and implementation of physical object visual interaction technology based on object model and visual SLAM}
]{zjuthesis}

% Uncomment the following lines if you need multi line titles on cover pages
\titletwolines{基于物模型与视觉SLAM的}{物理对象可视交互技术研究与实现}
% \titleengtwolines{Research and implementation of physical object visual interaction technology }{based on object model and visual SLAM}
